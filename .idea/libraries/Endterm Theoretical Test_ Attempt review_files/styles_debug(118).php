...
:root {--blue: #1177d1;--indigo: #6610f2;--purple: #613d7c;--pink: #e83e8c;--red: #d9534f;--orange: #f0ad4e;--yellow: #ff7518;--green: #5cb85c;--teal: #20c997;--cyan: #5bc0de;--white: #fff;--gray: #868e96;--gray-dark: #373a3c;--primary: #1177d1;--secondary: #ced4da;--success: #5cb85c;--info: #5bc0de;--warning: #f0ad4e;--danger: #d9534f;--light: #f8f9fa;--dark: #373a3c;--breakpoint-xs: 0;--breakpoint-sm: 576px;--breakpoint-md: 768px;--breakpoint-lg: 992px;--breakpoint-xl: 1200px;--font-family-sans-serif: -apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,"Noto Sans",sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol","Noto Color Emoji";--font-family-monospace: SFMono-Regular,Menlo,Monaco,Consolas,"Liberation Mono","Courier New",monospace;}
*, *::before, *::after {-webkit-box-sizing: border-box;box-sizing: border-box;}
html {font-family: sans-serif;line-height: 1.15;-webkit-text-size-adjust: 100%;-webkit-tap-highlight-color: rgba(0,0,0,0);}
article, aside, figcaption, figure, footer, header, hgroup, main, nav, section {display: block;}
body {margin: 0;font-family: -apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,"Noto Sans",sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol","Noto Color Emoji";font-size: .9375rem;font-weight: 400;line-height: 1.5;color: #373a3c;text-align: left;background-color: #fff;}
...
.table, table.collection, table.flexible, .generaltable {width: 100%;margin-bottom: 1rem;color: #373a3c;}
...
.table-hover tbody tr:hover, table.grading-report tbody tr:hover, .forumheaderlist tbody tr:hover, .generaltable tbody tr:hover, table.flexible tbody tr:hover, .category_subcategories tbody tr:hover, table#modules tbody tr:hover, table#permissions tbody tr:hover {color: #373a3c;background-color: rgba(0,0,0,.075);}
...
.table-dark th, .table-dark td, .table-dark thead th, .table-dark tbody + tbody {border-color: #97999a;}
...
.table-dark {color: #fff;background-color: #373a3c;}
.table-dark th, .table-dark td, .table-dark thead th {border-color: #494d50;}
...
.form-control-plaintext {display: block;width: 100%;padding-top: .375rem;padding-bottom: .375rem;margin-bottom: 0;line-height: 1.5;color: #373a3c;background-color: transparent;border: solid transparent;border-width: 1px 0;}
...
.valid-tooltip {position: absolute;top: 100%;z-index: 5;display: none;max-width: 100%;padding: .25rem .5rem;margin-top: .1rem;font-size: .8203125rem;line-height: 1.5;color: #fff;background-color: rgba(92,184,92,.9);}
...
.was-validated .form-control:valid:focus, .form-control.is-valid:focus {border-color: #5cb85c;-webkit-box-shadow: 0 0 0 .2rem rgba(92,184,92,.25);box-shadow: 0 0 0 .2rem rgba(92,184,92,.25);}
...
.was-validated .custom-select:valid:focus, .custom-select.is-valid:focus {border-color: #5cb85c;-webkit-box-shadow: 0 0 0 .2rem rgba(92,184,92,.25);box-shadow: 0 0 0 .2rem rgba(92,184,92,.25);}
...
.was-validated .custom-control-input:valid:focus ~ .custom-control-label::before, .custom-control-input.is-valid:focus ~ .custom-control-label::before {-webkit-box-shadow: 0 0 0 .2rem rgba(92,184,92,.25);box-shadow: 0 0 0 .2rem rgba(92,184,92,.25);}
...
.was-validated .custom-file-input:valid:focus ~ .custom-file-label, .custom-file-input.is-valid:focus ~ .custom-file-label {border-color: #5cb85c;-webkit-box-shadow: 0 0 0 .2rem rgba(92,184,92,.25);box-shadow: 0 0 0 .2rem rgba(92,184,92,.25);}
.invalid-feedback {display: none;width: 100%;margin-top: .25rem;font-size: 80%;color: #d9534f;}
.invalid-tooltip {position: absolute;top: 100%;z-index: 5;display: none;max-width: 100%;padding: .25rem .5rem;margin-top: .1rem;font-size: .8203125rem;line-height: 1.5;color: #fff;background-color: rgba(217,83,79,.9);}
...
.was-validated .form-control:invalid:focus, .form-control.is-invalid:focus {border-color: #d9534f;-webkit-box-shadow: 0 0 0 .2rem rgba(217,83,79,.25);box-shadow: 0 0 0 .2rem rgba(217,83,79,.25);}
...
.was-validated .custom-select:invalid, .custom-select.is-invalid {border-color: #d9534f;padding-right: calc(( 1em + .75rem ) * 3 / 4 + 1.75rem);background: url("data:image/svg+xml,%3csvg xmlns=\'http://www.w3.org/2000/svg\' viewBox=\'0 0 4 5\'%3e%3cpath fill=\'%23373a3c\' d=\'M2 0L0 2h4zm0 5L0 3h4z\'/%3e%3c/svg%3e") no-repeat right .75rem center/8px 10px,url("data:image/svg+xml,%3csvg xmlns=\'http://www.w3.org/2000/svg\' fill=\'%23d9534f\' viewBox=\'-2 -2 7 7\'%3e%3cpath stroke=\'%23d9534f\' d=\'M0 0l3 3m0-3L0 3\'/%3e%3ccircle r=\'.5\'/%3e%3ccircle cx=\'3\' r=\'.5\'/%3e%3ccircle cy=\'3\' r=\'.5\'/%3e%3ccircle cx=\'3\' cy=\'3\' r=\'.5\'/%3e%3c/svg%3E") #fff no-repeat center right 1.75rem/calc(.75em + .375rem) calc(.75em + .375rem);}
.was-validated .custom-select:invalid:focus, .custom-select.is-invalid:focus {border-color: #d9534f;-webkit-box-shadow: 0 0 0 .2rem rgba(217,83,79,.25);box-shadow: 0 0 0 .2rem rgba(217,83,79,.25);}
...
.was-validated .custom-control-input:invalid:focus ~ .custom-control-label::before, .custom-control-input.is-invalid:focus ~ .custom-control-label::before {-webkit-box-shadow: 0 0 0 .2rem rgba(217,83,79,.25);box-shadow: 0 0 0 .2rem rgba(217,83,79,.25);}
...
.was-validated .custom-file-input:invalid:focus ~ .custom-file-label, .custom-file-input.is-invalid:focus ~ .custom-file-label {border-color: #d9534f;-webkit-box-shadow: 0 0 0 .2rem rgba(217,83,79,.25);box-shadow: 0 0 0 .2rem rgba(217,83,79,.25);}
...
@media (prefers-reduced-motion: reduce) {.btn, #page-grade-grading-manage .actions .action, #rubric-rubric.gradingform_rubric #rubric-criteria .criterion .addlevel input, #rubric-rubric.gradingform_rubric .addcriterion {-webkit-transition: none;-o-transition: none;transition: none;}}
.btn:hover, #page-grade-grading-manage .actions .action:hover, #rubric-rubric.gradingform_rubric #rubric-criteria .criterion .addlevel input:hover, #rubric-rubric.gradingform_rubric .addcriterion:hover {color: #373a3c;text-decoration: none;}
...
.btn-success:focus, .btn-success.focus {-webkit-box-shadow: 0 0 0 .2rem rgba(116,195,116,.5);box-shadow: 0 0 0 .2rem rgba(116,195,116,.5);}
...
.btn-success:not(:disabled):not(.disabled):active:focus, .btn-success:not(:disabled):not(.disabled).active:focus, .show > .btn-success.dropdown-toggle:focus {-webkit-box-shadow: 0 0 0 .2rem rgba(116,195,116,.5);box-shadow: 0 0 0 .2rem rgba(116,195,116,.5);}
...
.btn-danger:focus, .btn-danger.focus {-webkit-box-shadow: 0 0 0 .2rem rgba(223,109,105,.5);box-shadow: 0 0 0 .2rem rgba(223,109,105,.5);}
...
.btn-danger:not(:disabled):not(.disabled):active:focus, .btn-danger:not(:disabled):not(.disabled).active:focus, .show > .btn-danger.dropdown-toggle:focus {-webkit-box-shadow: 0 0 0 .2rem rgba(223,109,105,.5);box-shadow: 0 0 0 .2rem rgba(223,109,105,.5);}
...
.btn-dark:focus, .btn-dark.focus {-webkit-box-shadow: 0 0 0 .2rem rgba(85,88,89,.5);box-shadow: 0 0 0 .2rem rgba(85,88,89,.5);}
...
.btn-dark:not(:disabled):not(.disabled):active:focus, .btn-dark:not(:disabled):not(.disabled).active:focus, .show > .btn-dark.dropdown-toggle:focus {-webkit-box-shadow: 0 0 0 .2rem rgba(85,88,89,.5);box-shadow: 0 0 0 .2rem rgba(85,88,89,.5);}
...
.btn-outline-dark {color: #373a3c;border-color: #373a3c;}
...
.btn-group-vertical > .btn, #page-grade-grading-manage .actions .btn-group-vertical > .action, #rubric-rubric.gradingform_rubric #rubric-criteria .criterion .addlevel .btn-group-vertical > input, #rubric-rubric.gradingform_rubric .btn-group-vertical > .addcriterion, .btn-group-vertical > .btn-group {width: 100%;}
.btn-group-vertical > .btn:not(:first-child), #page-grade-grading-manage .actions .btn-group-vertical > .action:not(:first-child), #rubric-rubric.gradingform_rubric #rubric-criteria .criterion .addlevel .btn-group-vertical > input:not(:first-child), #rubric-rubric.gradingform_rubric .btn-group-vertical > .addcriterion:not(:first-child), .btn-group-vertical > .btn-group:not(:first-child) {margin-top: -1px;}
...
.breadcrumb-item + .breadcrumb-item::before {display: inline-block;padding-right: .5rem;color: #868e96;content: "/";}
...
.badge-success[href]:hover, .badge-success[href]:focus {color: #fff;background-color: #449d44;}
.badge-success[href]:focus, .badge-success[href].focus {outline: 0;-webkit-box-shadow: 0 0 0 .2rem rgba(92,184,92,.5);box-shadow: 0 0 0 .2rem rgba(92,184,92,.5);}
...
.badge-danger[href]:hover, .badge-danger[href]:focus {color: #fff;background-color: #c9302c;}
.badge-danger[href]:focus, .badge-danger[href].focus {outline: 0;-webkit-box-shadow: 0 0 0 .2rem rgba(217,83,79,.5);box-shadow: 0 0 0 .2rem rgba(217,83,79,.5);}
...
.badge-dark[href]:hover, .badge-dark[href]:focus {color: #fff;background-color: #1f2021;}
.badge-dark[href]:focus, .badge-dark[href].focus {outline: 0;-webkit-box-shadow: 0 0 0 .2rem rgba(55,58,60,.5);box-shadow: 0 0 0 .2rem rgba(55,58,60,.5);}
...
.toast-header {display: flex;align-items: center;padding: .25rem .75rem;color: #868e96;background-color: rgba(255,255,255,.85);-webkit-background-clip: padding-box;background-clip: padding-box;border-bottom: 1px solid rgba(0,0,0,.05);}
...
a.text-success:hover, a.green:hover, a.notifysuccess:hover, a.connected:hover, a.text-success:focus, a.green:focus, a.notifysuccess:focus, a.connected:focus {color: #3d8b3d !important;}
...
a.text-danger:hover, a.notconnected:hover, .que a.validationerror:hover, a.text-error:hover, a.text-danger:focus, a.notconnected:focus, .que a.validationerror:focus, a.text-error:focus {color: #b52b27 !important;}
.text-light {color: #f8f9fa !important;}
a.text-light:hover, a.text-light:focus {color: #cbd3da !important;}
.text-dark, #categoryquestions .highlight {color: #373a3c !important;}
a.text-dark:hover, #categoryquestions a.highlight:hover, a.text-dark:focus, #categoryquestions a.highlight:focus {color: #121314 !important;}
...
.switch input {float: left;width: 1px;-webkit-transform: translateX(1px);-moz-transform: translateX(1px);-ms-transform: translateX(1px);-o-transform: translateX(1px);transform: translateX(1px);padding: 0;margin: 0;opacity: 0;line-height: 1.25rem;}
.switch input + label {position: relative;min-height: 1.25rem;min-width: 2.5rem;line-height: 1.25rem;border-radius: 1.25rem;display: inline-block;cursor: pointer;outline: none;-webkit-user-select: none;-moz-user-select: none;-ms-user-select: none;user-select: none;padding-left: 3rem;}
.switch input + label::before, .switch input + label::after {content: "";position: absolute;left: 0;bottom: 0;display: block;}
.switch input + label::before {right: 0;height: 1rem;width: 2.5rem;top: calc(50% - .5rem);background-color: #dee2e6;border-radius: 1.25rem;-webkit-transition: .2s all;-o-transition: .2s all;transition: .2s all;}
.switch input + label::after {left: 0;width: 1.25rem;height: 1.25rem;top: calc(50% - .625rem);border-radius: 50%;background-color: #fff;-webkit-transition: .2s all;-o-transition: .2s all;transition: .2s all;-webkit-box-shadow: 0 1px 3px 0 rgba(0,0,0,.2),0 1px 1px 0 rgba(0,0,0,.14),0 2px 1px -1px rgba(0,0,0,.12);box-shadow: 0 1px 3px 0 rgba(0,0,0,.2),0 1px 1px 0 rgba(0,0,0,.14),0 2px 1px -1px rgba(0,0,0,.12);}
.switch input:checked + label::before {background-color: rgba(17,119,209,.4);}
.switch input:checked + label::after {margin-left: 1.25rem;background-color: #1177d1;}
.switch input:focus + label::before {outline: none;}
.switch input:focus + label::after {outline: none;-webkit-box-shadow: 0 0 0 .4rem rgba(17,119,209,.25);box-shadow: 0 0 0 .4rem rgba(17,119,209,.25);}
.switch input:disabled + label {color: #868e96;cursor: not-allowed;}
.switch input:disabled + label::before {background-color: #e9ecef;}
.switch input:disabled + label::after {background-color: #868e96;}
.switch.sr-only-label input + label {text-indent: -9999px;margin-bottom: 0;padding-left: 0;}
...
#page-admin-tasklogs .task-class {font-size: .8203125rem;color: #868e96;}
...
.form-autocomplete-downarrow {color: #373a3c;top: .2rem;right: .5rem;cursor: pointer;}
...
.path-mod-forum .unified-grader .grader-grading-panel.hidden + .grader-module-content {margin-right: 0;}
...
.btn.btn-icon, #page-grade-grading-manage .actions .btn-icon.action, #rubric-rubric.gradingform_rubric #rubric-criteria .criterion .addlevel input.btn-icon, #rubric-rubric.gradingform_rubric .btn-icon.addcriterion {height: 36px;width: 36px;font-size: 16px;line-height: 16px;padding: 0;border-radius: 50%;flex-shrink: 0;}
.btn.btn-icon:hover, #page-grade-grading-manage .actions .btn-icon.action:hover, #rubric-rubric.gradingform_rubric #rubric-criteria .criterion .addlevel input.btn-icon:hover, #rubric-rubric.gradingform_rubric .btn-icon.addcriterion:hover, .btn.btn-icon:focus, #page-grade-grading-manage .actions .btn-icon.action:focus, #rubric-rubric.gradingform_rubric #rubric-criteria .criterion .addlevel input.btn-icon:focus, #rubric-rubric.gradingform_rubric .btn-icon.addcriterion:focus {background-color: #e9ecef;}
.btn.btn-icon.icon-size-0, #page-grade-grading-manage .actions .btn-icon.icon-size-0.action, #rubric-rubric.gradingform_rubric #rubric-criteria .criterion .addlevel input.btn-icon.icon-size-0, #rubric-rubric.gradingform_rubric .btn-icon.icon-size-0.addcriterion {height: 20px !important;width: 20px !important;font-size: 0 !important;line-height: 0 !important;}
...
.btn-outline-secondary {color: #868e96;border-color: #868e96;border-color: #dee2e6;}
