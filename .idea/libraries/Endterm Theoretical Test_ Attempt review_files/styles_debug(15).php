...
#page-mod-attendance-report .attendancereporttable .headcol {position: absolute;width: 200px;left: 15px;top: auto;border-top-width: 1px;}
...
#page-mod-attendance-report.has-region-side-pre:not(.empty-region-side-pre) .attendancereporttable .headcol {left: 370px;}
#page-mod-attendance-report.has-region-side-pre:not(.empty-region-side-pre) .attendancereporttable {margin-left: 230px;}
#page-mod-attendance-report.has-region-side-pre:not(.empty-region-side-pre).content-only .attendancereporttable .headcol {left: 80px;}
@media (max-width: 767px) {#page-mod-attendance-report.has-region-side-pre:not(.empty-region-side-pre) .attendancereporttable .headcol {left: 80px;}}
